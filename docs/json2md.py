...
room = Literal['room0', 'room1', 'room2', 'office0', 'office1', 'office2', 'office3', 'office4']
...
def process_replica_data(data: Dict[data_set, Dict[room, Dict[exp_methods, Dict[error, float]]]]) -> Tuple[pd.DataFrame, pd.DataFrame]:
    """
    ...
    sequence_order: list[room] = ['room0', 'room1', 'room2', 'office0', 'office1', 'office2', 'office3', 'office4']
...
def process_tum_data(data: Dict[str, Dict[str, Dict[str, Dict[str, float]]]]) -> Tuple[pd.DataFrame, pd.DataFrame]:
    """
